...
(custom-set-variables
 ...
 '(package-selected-packages
   '(cricbuzz ivy-youtube counsel-spotify org-gcal ivy-pass lorem-ipsum forge evil-magit magit counsel-projectile projectile company-box company lsp-python-ms scss-mode skewer-mode impatient-mode web-mode prettier-js js2-mode typescript-mode lsp-treemacs lsp-ivy lsp-ui lsp-mode speed-type counsel-osx-app org-alert org-make-toc org-special-block-extras visual-fill-column org-plus-contrib org-bullets hydra evil-nerd-commenter yasnippet emmet-mode autopair helpful which-key counsel ivy-rich ivy command-log-mode evil-collection evil general rainbow-delimiters doom-themes doom-modeline all-the-icons use-package exec-path-from-shell autothemer)))
(custom-set-faces
